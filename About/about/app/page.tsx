...
export default function About() {
  ...
  const steps = [
    ...
    },
    {
      image: "hero-3.png",
      title:
        "We then take the latest technology and marry it with technical design",
                ...
                >
                  ...
                  >
                    <p className="text-xl md:text-2xl text-gray-700 leading-relaxed font-medium">
                      He wanted to create a comfortable, on-the-go shoe that
                      felt just as good as it looked.
                    </p>
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <motion.circle
                          ...
                          strokeDasharray={220}
                          strokeDashoffset={
                            220 - 220 * currentStepData.progress
                          }
                          strokeLinecap="round"
              ...
              >
                ...
                >
                  <div className="relative">
                    ...
                    >
                      Armed with a simple sketch and a challenge, Rollie Nation
                      was born.
                    </motion.p>
                  </div>
                  ...
                  >
                    <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
                      Our footwear is everything shoes should be. Comfy enough
                      for all-day adventures, beautifully designed, and wholly
                      unique. Through trial and error, a decade of learning and
                      relearning we've perfected our craft and we're ready to
                      share it with you.
                    </p>
